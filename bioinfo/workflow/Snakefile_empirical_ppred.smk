...
rule all:
    input:
        ...
        # expand(ROOT_dir+"/outputs/empirical/pbmpi_m0gtr/{geneID}-M0GTR-{repID}-cluster.sh", geneID=GENEID, repID=REPID),
        # expand(ROOT_dir+"/outputs/empirical/pbmpi_m0gtr/{geneID}-M0GTR-{repID}.sh", geneID=GENEID, repID=REPID),
        # expand(ROOT_dir+"/outputs/empirical/pbmpi_m0gtr/{geneID}-M0GTR-{repID}.chain", geneID=GENEID, repID=REPID),
        expand(ROOT_dir+"/outputs/empirical/ppred_test/readpb_m0gtr/{geneID}-M0GTR-{repID}.sh", geneID=GENEID, repID=REPID),
        expand(ROOT_dir+"/outputs/empirical/ppred_test/readpb_m0gtr/{geneID}-M0GTR-{repID}_ppred.touchdown", geneID=GENEID, repID=REPID),
        expand(ROOT_dir+"/outputs/empirical/ppred_test/stats/{geneID}-M0GTR-{repID}_ppred.tsv",geneID=GENEID, repID=REPID),
