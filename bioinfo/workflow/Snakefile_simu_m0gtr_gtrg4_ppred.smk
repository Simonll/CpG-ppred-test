...
rule all:
    input:
        ...
        # expand(ROOT_dir+"/outputs/simulation/m0gtr/pbmpi_gtrg4/{geneID}-GTRG4-{omega}-{CpG}-{TpA}-{tbl}-{draw}-{repID}.sh",geneID=GENEID, CpG=CPG, TpA=TPA, tbl=TBL, omega=OMEGA, draw=DRAW,repID=REPID),
        # expand(ROOT_dir+"/outputs/simulation/m0gtr/pbmpi_gtrg4/{geneID}-GTRG4-{omega}-{CpG}-{TpA}-{tbl}-{draw}-{repID}-cluster.sh",geneID=GENEID, CpG=CPG, TpA=TPA, tbl=TBL, omega=OMEGA, draw=DRAW,repID=REPID),
        # expand(ROOT_dir+"/outputs/simulation/m0gtr/readpb_gtrg4/{geneID}-GTRG4-{omega}-{CpG}-{TpA}-{tbl}-{draw}-{repID}.sh",geneID=GENEID, CpG=CPG, TpA=TPA, tbl=TBL, omega=OMEGA, draw=DRAW,repID=REPID),
        expand(ROOT_dir+"/outputs/simulation/m0gtr/ppred_test/readpb_gtrg4/{geneID}-GTRG4-{omega}-{CpG}-{TpA}-{tbl}-{draw}-{repID}.sh",geneID=GENEID, CpG=CPG, TpA=TPA, tbl=TBL, omega=OMEGA, draw=DRAW,repID=REPID),
        expand(ROOT_dir+"/outputs/simulation/m0gtr/ppred_test/readpb_gtrg4/{geneID}-GTRG4-{omega}-{CpG}-{TpA}-{tbl}-{draw}-{repID}_ppred.touchdown",geneID=GENEID, CpG=CPG, TpA=TPA, tbl=TBL, omega=OMEGA, draw=DRAW,repID=REPID),
        expand(ROOT_dir+"/outputs/simulation/m0gtr/ppred_test/readpb_gtrg4/{geneID}-GTRG4-{omega}-{CpG}-{TpA}-{tbl}-{draw}-{repID}_ppred.zip",geneID=GENEID, CpG=CPG, TpA=TPA, tbl=TBL, omega=OMEGA, draw=DRAW, repID=REPID),
        expand(ROOT_dir+"/outputs/simulation/m0gtr/ppred_test/stats/{geneID}-GTRG4-{omega}-{CpG}-{TpA}-{tbl}-{draw}-{repID}_ppred.tsv",geneID=GENEID, CpG=CPG, TpA=TPA, tbl=TBL, omega=OMEGA, draw=DRAW, repID=REPID),
